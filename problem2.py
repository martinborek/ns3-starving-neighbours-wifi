...
wifiA.SetRemoteStationManager("ns3::ConstantRateWifiManager", "DataMode", ns.core.StringValue("DsssRate1Mbps"), "ControlMode",ns.core.StringValue("DsssRate1Mbps"))
...
mobility.SetPositionAllocator ("ns3::GridPositionAllocator", "MinX", ns.core.DoubleValue(0.0), "MinY", ns.core.DoubleValue (0.0), "DeltaX", ns.core.DoubleValue(2.0), "DeltaY", ns.core.DoubleValue(2.0),          "GridWidth", ns.core.UintegerValue(2), "LayoutType", ns.core.StringValue("RowFirst"))
...
echoClient.SetAttribute("MaxPackets", ns.core.UintegerValue(999999999))
echoClient.SetAttribute("Interval", ns.core.TimeValue(ns.core.Seconds(0.01)))
echoClient.SetAttribute("PacketSize", ns.core.UintegerValue(2000))

clientApps = echoClient.Install(apB)
clientApps.Start(ns.core.Seconds(1.00))
...
echoServer = ns.applications.UdpEchoServerHelper(9)
serverApps = echoServer.Install(hc)
serverApps.Start(ns.core.Seconds(1.0))
serverApps.Stop(ns.core.Seconds(200.0))

#echoClient = ns.applications.UdpEchoClientHelper(inter_hb.GetAddress(0), 9)
echoClient = ns.applications.UdpEchoClientHelper(wifiInterfaces.GetAddress(4), 9)
echoClient.SetAttribute("MaxPackets", ns.core.UintegerValue(99999999))
echoClient.SetAttribute("Interval", ns.core.TimeValue(ns.core.Seconds(0.01)))
echoClient.SetAttribute("PacketSize", ns.core.UintegerValue(2000))

clientApps = echoClient.Install(apC)
...
echoServer = ns.applications.UdpEchoServerHelper(9)
serverApps = echoServer.Install(ha)
serverApps.Start(ns.core.Seconds(0.5))
serverApps.Stop(ns.core.Seconds(200.0))

#echoClient = ns.applications.UdpEchoClientHelper(inter_hb.GetAddress(0), 9)
echoClient = ns.applications.UdpEchoClientHelper(wifiInterfaces.GetAddress(0), 9)
echoClient.SetAttribute("MaxPackets", ns.core.UintegerValue(99999999))
echoClient.SetAttribute("Interval", ns.core.TimeValue(ns.core.Seconds(0.01)))
echoClient.SetAttribute("PacketSize", ns.core.UintegerValue(2000))

clientApps = echoClient.Install(apA)
clientApps.Start(ns.core.Seconds(1.0))
clientApps.Stop(ns.core.Seconds(200.0))
